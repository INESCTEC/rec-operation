...
from rec_op_lem_prices.optimization.structures.I_O_stage_2_pool_milp_hp import (
	INPUTS_S2_POOL_HP,
	OUTPUTS_S2_POOL_HP
)
...
def test_solve_collective_pool_milp():
	...
	milp = StageTwoMILPPool(INPUTS_S2_POOL_HP)
	...
	for ki, valu in results.items():
		assert valu == OUTPUTS_S2_POOL_HP.get(ki), f'{ki}'
