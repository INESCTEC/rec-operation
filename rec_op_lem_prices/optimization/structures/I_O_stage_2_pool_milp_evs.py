...
OUTPUTS_S2_POOL_EVS = {'obj_value': -0.38501,
					   'milp_status': 'Optimal',
					   ...
					   'e_sur_market': {'Meter#1': [0.0, 0.0, 0.397], 'Meter#2': [0.0, 0.0, 0.0]},
					   ...
					   'c_ind2pool': {'Meter#1': -0.718, 'Meter#2': 0.333},
					   'c_ind2pool_without_deg': {'Meter#1': -0.727, 'Meter#2': 0.333},
					   'c_ind2pool_without_deg_and_p_extra': {'Meter#1': -0.727, 'Meter#2': 0.333},
					   'c_ind2pool_without_p_extra': {'Meter#1': -0.718, 'Meter#2': 0.333},
					   'deg_cost2pool': {'Meter#1': 0.00899, 'Meter#2': 0},
...
OUTPUTS_S2_DUAL_EVS = {'obj_value': 1.006,
					   'milp_status': 'Optimal',
					   'e_sup_retail': {'Meter#1': [0.0, 0.0, 0.0], 'Meter#2': [0.0, 0.0, 0.0]},
					   'e_sur_retail': {'Meter#1': [0.8, 0.0, 0.0], 'Meter#2': [0.0, 0.0, 0.0]},
					   'e_sup_market': {'Meter#1': [0.0, 0.401, 0.0], 'Meter#2': [0.0, 0.1, 0.001]},
					   'e_sur_market': {'Meter#1': [0.0, 0.0, 0.0], 'Meter#2': [0.0, 0.0, 0.0]},
					   'delta_sup': {'Meter#1': [0.0, 1.0, 1.0], 'Meter#2': [1.0, 1.0, 1.0]},
					   'e_pur_pool': {'Meter#1': [0.0, 0.0, 0.0], 'Meter#2': [0.1, 0.0, 0.099]},
					   'e_sale_pool': {'Meter#1': [0.1, 0.0, 0.099], 'Meter#2': [0.0, 0.0, 0.0]},
					   'e_cmet': {'Meter#1': [-0.9, 0.401, -0.099], 'Meter#2': [0.1, 0.1, 0.1]},
					   'e_slc_pool': {'Meter#1': [0.0, 0.0, 0.0], 'Meter#2': [0.1, 0.0, 0.099]},
					   'e_consumed': {'Meter#1': [0.0, 0.401, 0.0], 'Meter#2': [0.1, 0.1, 0.1]},
					   'e_alc': {'Meter#1': [0.0, 0.0, 0.0], 'Meter#2': [0.1, 0.0, 0.099]},
					   'delta_slc': {'Meter#1': [1.0, 0.0, 0.0], 'Meter#2': [0.0, 0.0, 0.0]},
					   'delta_cmet': {'Meter#1': [0.0, 0.0, 0.0], 'Meter#2': [0.0, 0.0, 0.0]},
					   'delta_alc': {'Meter#1': [0.0, 0.0, 0.0], 'Meter#2': [0.0, 0.0, 0.0]},
					   'p_extra': {'Meter#1': [0.0, 0.0, 0.0], 'Meter#2': [0.0, 0.0, 0.0]},
					   'e_bat': {'Meter#1': {}, 'Meter#2': {}}, 'soc_bat': {'Meter#1': {}, 'Meter#2': {}},
					   'e_bc': {'Meter#1': {}, 'Meter#2': {}},
					   'e_bd': {'Meter#1': {}, 'Meter#2': {}},
					   'delta_bc': {'Meter#1': {}, 'Meter#2': {}},
					   'ev_stored': {'Meter#1': {'EV#1': [0.9, 0.8, 0.7]}, 'Meter#2': {}},
					   'p_ev_charge': {'Meter#1': {'EV#1': [0.0, 0.0, 0.0]}, 'Meter#2': {}},
					   'p_ev_discharge': {'Meter#1': {'EV#1': [0.0, 0.099, 0.099]}, 'Meter#2': {}},
					   'delta_coeff': {'Meter#1': [0.0, 1.0, 0.0], 'Meter#2': [1.0, 1.0, 1.0]},
					   'c_ind2pool': {'Meter#1': 0.583, 'Meter#2': 0.423},
					   'c_ind2pool_without_deg': {'Meter#1': 0.583, 'Meter#2': 0.423},
					   'c_ind2pool_without_deg_and_p_extra': {'Meter#1': 0.583, 'Meter#2': 0.423},
					   'c_ind2pool_without_p_extra': {'Meter#1': 0.583, 'Meter#2': 0.423},
					   'deg_cost2pool': {'Meter#1': 0, 'Meter#2': 0},
					   'p_extra_cost2pool': {'Meter#1': 0.0, 'Meter#2': 0.0},
					   'dual_prices': [0.0, 2.0, 1.99]}
