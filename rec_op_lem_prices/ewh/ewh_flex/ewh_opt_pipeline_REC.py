...
def ewh_preparation(params_input, dataset, resample = 'no', optSolver = 'HiGHS', solverPath=None):
    ...
    # new: add resampled data to varBackpack, for objective function disaggregation
